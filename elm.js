...
var $author$project$Msg$QuoteRecieved = function (a) {
	return {$: 'QuoteRecieved', a: a};
};
var $author$project$Msg$GeneratedRandomMatrix = function (a) {
	return {$: 'GeneratedRandomMatrix', a: a};
};
...
var $author$project$Bubble$Unpopped = {$: 'Unpopped'};
...
var $author$project$Bubble$Black = {$: 'Black'};
var $author$project$Bubble$Blue = {$: 'Blue'};
var $author$project$Bubble$Green = {$: 'Green'};
var $author$project$Bubble$Red = {$: 'Red'};
var $author$project$Bubble$Yellow = {$: 'Yellow'};
...
var $author$project$RandomGenerator$randomColor = A2(
	$elm$random$Random$uniform,
	$author$project$Bubble$Red,
	_List_fromArray(
		[$author$project$Bubble$Green, $author$project$Bubble$Blue, $author$project$Bubble$Yellow, $author$project$Bubble$Black]));
var $author$project$RandomGenerator$randomMatrix = F2(
	function (r, c) {
		return A2(
			$elm$random$Random$list,
			$elm$core$Basics$floor(r),
			A2(
				$elm$random$Random$list,
				...
				A2(
					$elm$random$Random$map,
					function (color) {
						return {color: color, state: $author$project$Bubble$Unpopped};
					},
					$author$project$RandomGenerator$randomColor)));
	});
var $author$project$RandomGenerator$generateNewMatrix = function (model) {
	return A2(
		$elm$random$Random$generate,
		$author$project$Msg$GeneratedRandomMatrix,
		A2($author$project$RandomGenerator$randomMatrix, model.rows, model.columns));
};
...
var $author$project$Quote$Quote = F3(
	function (msg, quote, author) {
		return {author: author, msg: msg, quote: quote};
	});
var $author$project$Quote$quoteDecoder = $elm$json$Json$Decode$list(
	A3(
		$elm$json$Json$Decode$map2,
		$author$project$Quote$Quote(''),
		A2($elm$json$Json$Decode$field, 'content', $elm$json$Json$Decode$string),
		A2($elm$json$Json$Decode$field, 'author', $elm$json$Json$Decode$string)));
var $author$project$RandomGenerator$getRandomQuote = function (msg) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, msg, $author$project$Quote$quoteDecoder),
			url: 'https://api.quotable.io/quotes/random'
		});
};
var $author$project$Matrix$Idle = {$: 'Idle'};
var $author$project$Model$initModel = {
	columns: 10,
	consoleLogMessage: '',
	keyPressed: $elm$core$Maybe$Nothing,
	matrix: _List_fromArray(
		[_List_Nil]),
	matrixState: $author$project$Matrix$Idle,
	quote: $elm$core$Maybe$Nothing,
	rows: 10
};
var $author$project$Cmd$initCmd = $elm$core$Platform$Cmd$batch(
	_List_fromArray(
		[
			$author$project$RandomGenerator$generateNewMatrix($author$project$Model$initModel),
			$author$project$RandomGenerator$getRandomQuote($author$project$Msg$QuoteRecieved)
		]));
...
var $author$project$Subscriptions$toMsg = function (str) {
	return $author$project$Msg$KeyPressed(str);
};
var $author$project$Subscriptions$subscriptionDecoderMsg = A2(
	$elm$json$Json$Decode$map,
	$author$project$Subscriptions$toMsg,
	A2($elm$json$Json$Decode$field, 'key', $elm$json$Json$Decode$string));
var $author$project$Subscriptions$subscriptions = function (_v0) {
	return $elm$browser$Browser$Events$onKeyPress($author$project$Subscriptions$subscriptionDecoderMsg);
};
var $author$project$Bubble$NoColor = {$: 'NoColor'};
var $author$project$Bubble$Popped = {$: 'Popped'};
var $author$project$Helper$changeBubbleState = F3(
	function (r, c, matrix) {
		return A2(
			$elm$core$List$indexedMap,
			F2(
				function (ir, row) {
					return _Utils_eq(ir, r) ? A2(
						$elm$core$List$indexedMap,
						F2(
							function (ic, bubble) {
								return _Utils_eq(ic, c) ? _Utils_update(
									bubble,
									{color: $author$project$Bubble$NoColor, state: $author$project$Bubble$Popped}) : bubble;
							}),
						row) : row;
				}),
			matrix);
...
var $author$project$Bubble$Bubble = F2(
...
var $author$project$Helper$getBubbleFromMatrix = F3(
	function (x, y, matrix) {
		var bubble = A2(
		...
		if (bubble.$ === 'Just') {
			...
			return A2($author$project$Bubble$Bubble, $author$project$Bubble$Unpopped, $author$project$Bubble$NoColor);
		}
	});
var $author$project$Helper$isMatrixBubbleOfColor = F4(
	function (r, c, matrix, color) {
		var bub = A3($author$project$Helper$getBubbleFromMatrix, r, c, matrix);
		return _Utils_eq(bub.color, color) && _Utils_eq(bub.state, $author$project$Bubble$Unpopped);
	});
var $author$project$Helper$isValidBubble = F3(
	function (r, c, matrix) {
		return (r >= 0) && ((_Utils_cmp(
			r,
			$elm$core$List$length(matrix)) < 0) && ((c >= 0) && (_Utils_cmp(
			c,
			$elm$core$List$length(
				A2(
					$elm$core$Maybe$withDefault,
					_List_Nil,
					$elm$core$List$head(matrix)))) < 0)));
	});
...
var $author$project$Matrix$neighbors = F2(
	function (r, c) {
		return _List_fromArray(
			[
				_Utils_Tuple2(r + 1, c),
...
var $author$project$Helper$bfsHelper = F4(
	function (queue, visited, matrix, color) {
		bfsHelper:
		while (true) {
			if (!queue.b) {
				return matrix;
				...
				if (A2(
					...
					var updatedVisited = A2(
						$elm$core$Set$insert,
						_Utils_Tuple2(row, col),
						visited);
					var newQueue = _Utils_ap(
						rest,
						A2(
							...
							function (_v2) {
								var r = _v2.a;
								var c = _v2.b;
								return A3($author$project$Helper$isValidBubble, r, c, matrix) && A4($author$project$Helper$isMatrixBubbleOfColor, r, c, matrix, color);
							},
							A2($author$project$Matrix$neighbors, row, col)));
					var newMatrix = A3($author$project$Helper$changeBubbleState, row, col, matrix);
...
var $author$project$Helper$bfsBubble = F4(
	function (x, y, matrix, color) {
		var visited = $elm$core$Set$empty;
		var queue = _List_fromArray(
			[
				_Utils_Tuple2(x, y)
			]);
		return A4($author$project$Helper$bfsHelper, queue, visited, matrix, color);
	});
var $author$project$Port$sendStringToJsForConsoleLog = _Platform_outgoingPort('sendStringToJsForConsoleLog', $elm$json$Json$Encode$string);
var $author$project$Cmd$consoleLog = function (printStr) {
	return $author$project$Port$sendStringToJsForConsoleLog(printStr);
};
var $author$project$Quote$emptyQuoteWithMsg = function (msg) {
	return A3($author$project$Quote$Quote, msg, '', '');
};
...
var $author$project$Update$movePoppedBubblesUpwards = function (column) {
	var _v0 = A2(
		$elm$core$List$partition,
		function (bubble) {
			return _Utils_eq(bubble.state, $author$project$Bubble$Popped);
		},
		column);
	var popped = _v0.a;
	var unpopped = _v0.b;
	return _Utils_ap(popped, unpopped);
};
...
var $author$project$Update$transpose = function (matrix) {
	if (!matrix.b) {
		return _List_Nil;
	} else {
		if (!matrix.a.b) {
			...
			var tails = A2(
				$elm$core$List$filterMap,
				$elm$core$Basics$identity,
				A2($elm$core$List$map, $elm$core$List$tail, matrix));
			var heads = A2(
				$elm$core$List$filterMap,
				$elm$core$Basics$identity,
				A2($elm$core$List$map, $elm$core$List$head, matrix));
			return A2(
				$elm$core$List$cons,
				heads,
				$author$project$Update$transpose(tails));
		}
	}
};
var $author$project$Update$updateBubbles = function (matrix) {
	var columns = $author$project$Update$transpose(matrix);
	var newColumns = A2($elm$core$List$map, $author$project$Update$movePoppedBubblesUpwards, columns);
	return $author$project$Update$transpose(newColumns);
};
	...
	function (msg, model) {
		switch (msg.$) {
			case 'ClickedBubble':
				var x = msg.a;
				var y = msg.b;
				var targetBubble = A3($author$project$Helper$getBubbleFromMatrix, x, y, model.matrix);
				var newMatrix = $author$project$Update$updateBubbles(
					A4($author$project$Helper$bfsBubble, x, y, model.matrix, targetBubble.color));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{matrix: newMatrix}),
					$elm$core$Platform$Cmd$none);
			case 'GeneratedRandomMatrix':
				var matrix = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'ChangedNumOfRows':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{rows: newRows}),
					$elm$core$Platform$Cmd$none);
			case 'ChangedNumOfColumns':
				var newColumns = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{columns: newColumns}),
			...
			case 'ConfigChanged':
				return _Utils_Tuple2(
					model,
					$author$project$RandomGenerator$generateNewMatrix(model));
			case 'QuoteRecieved':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var quotesList = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								quote: $elm$core$List$head(quotesList)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								quote: $elm$core$Maybe$Just(
									$author$project$Quote$emptyQuoteWithMsg('Error Fetching data'))
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'KeyPressed':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							keyPressed: $elm$core$Maybe$Just(key)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ConsoleLogMessageInputChanged':
				var consoleLogMessage = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			default:
				return _Utils_Tuple2(
					model,
					$author$project$Cmd$consoleLog(model.consoleLogMessage));
		}
	});
...
var $author$project$Msg$ClickedBubble = F2(
	function (a, b) {
		return {$: 'ClickedBubble', a: a, b: b};
	});
var $author$project$Bubble$bubbleDiameter = 30;
...
var $andrewMacmurray$elm_simple_animation$Internal$Ease$EaseInOut = {$: 'EaseInOut'};
var $andrewMacmurray$elm_simple_animation$Simple$Transition$easeInOut = $andrewMacmurray$elm_simple_animation$Internal$Transition$Ease($andrewMacmurray$elm_simple_animation$Internal$Ease$EaseInOut);
...
var $author$project$Bubble$getRgbColor = function (color) {
	switch (color.$) {
		case 'Red':
		...
		case 'Yellow':
			return _Utils_Tuple3(0, 125, 125);
		case 'Black':
			return _Utils_Tuple3(0, 0, 0);
		case 'Grey':
			return _Utils_Tuple3(150, 150, 150);
		default:
...
var $andrewMacmurray$elm_simple_animation$Simple$Transition$transform = $andrewMacmurray$elm_simple_animation$Simple$Transition$property('transform');
var $author$project$View$bubbleGrid = function (matrix) {
	var viewBubble = F3(
		function (x, y, bubble) {
			return A2(
				...
				_List_fromArray(
					[
						...
						A2($author$project$Msg$ClickedBubble, x, y)),
						$mdgriffith$elm_ui$Element$mouseOver(
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$scale(1.2)
							])),
						...
						$andrewMacmurray$elm_simple_animation$Simple$Transition$properties(
							_List_fromArray(
								[
									A2(
									$andrewMacmurray$elm_simple_animation$Simple$Transition$transform,
									100,
									_List_fromArray(
										[$andrewMacmurray$elm_simple_animation$Simple$Transition$easeInOut]))
								])))
					]),
				A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$px($author$project$Bubble$bubbleDiameter)),
							...
							function (_v0) {
								...
								$author$project$Bubble$getRgbColor(bubble.color))),
							$mdgriffith$elm_ui$Element$Border$rounded(20)
						]),
					$mdgriffith$elm_ui$Element$none));
		});
	var bubbleGridRow = F2(
		function (x, row) {
			return A2(
	...
	return A2(
		...
		A2($elm$core$List$indexedMap, bubbleGridRow, matrix));
};
var $author$project$Msg$ChangedNumOfColumns = function (a) {
	return {$: 'ChangedNumOfColumns', a: a};
};
var $author$project$Msg$ChangedNumOfRows = function (a) {
	return {$: 'ChangedNumOfRows', a: a};
};
var $author$project$Msg$ConfigChanged = {$: 'ConfigChanged'};
...
var $author$project$View$generateNewMatrixButton = A2(
	$mdgriffith$elm_ui$Element$Input$button,
	_List_Nil,
	{
		label: $mdgriffith$elm_ui$Element$text('Generate New Matrix'),
		onPress: $elm$core$Maybe$Just($author$project$Msg$ConfigChanged)
	});
var $author$project$Bubble$Grey = {$: 'Grey'};
...
var $author$project$View$slider = F3(
							...
							_List_fromArray(
								[
									...
									function (_v0) {
										...
										$author$project$Bubble$getRgbColor($author$project$Bubble$Grey))),
					...
					]),
				{
					label: A2(
						...
						$mdgriffith$elm_ui$Element$text(
							label + (' ' + $elm$core$Debug$toString(value)))),
					max: 25,
					min: 0,
					onChange: msg,
...
var $author$project$View$config = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_Nil,
		_List_fromArray(
			[
				A3($author$project$View$slider, 'Rows', model.rows, $author$project$Msg$ChangedNumOfRows),
				A3($author$project$View$slider, 'Columns', model.columns, $author$project$Msg$ChangedNumOfColumns),
				$author$project$View$generateNewMatrixButton
			]));
};
var $author$project$View$sectionAttr = _List_fromArray(
	[
...
var $author$project$View$viewTitleWithSubheading = F2(
	function (title, subheading) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			$author$project$View$sectionAttr,
			_List_fromArray(
				[
					A2(
					$mdgriffith$elm_ui$Element$el,
					...
					$mdgriffith$elm_ui$Element$el,
					_List_Nil,
					$mdgriffith$elm_ui$Element$text(subheading))
				]));
	});
var $author$project$View$viewBubbleGrid = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		$author$project$View$sectionAttr,
		_List_fromArray(
			[
				A2($author$project$View$viewTitleWithSubheading, 'Bubble', 'Click on a bubble to pop it and some bubbles close by of same color'),
				A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$author$project$View$bubbleGrid(model.matrix),
						$author$project$View$config(model)
					]))
			]));
};
var $author$project$Msg$ConsoleLogButtonClicked = {$: 'ConsoleLogButtonClicked'};
var $author$project$Msg$ConsoleLogMessageInputChanged = function (a) {
	return {$: 'ConsoleLogMessageInputChanged', a: a};
};
var $mdgriffith$elm_ui$Internal$Model$Bottom = {$: 'Bottom'};
var $mdgriffith$elm_ui$Element$alignBottom = $mdgriffith$elm_ui$Internal$Model$AlignY($mdgriffith$elm_ui$Internal$Model$Bottom);
var $author$project$View$buttonAttr = _List_fromArray(
	[
...
var $author$project$View$viewTitle = function (string) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var $author$project$View$viewConsolePrintInput = function () {
	var viewInputLabel = A2(
		$mdgriffith$elm_ui$Element$Input$labelLeft,
		_List_Nil,
		A2(
			$mdgriffith$elm_ui$Element$el,
			_List_Nil,
			$mdgriffith$elm_ui$Element$text('Console Log Input: ')));
	var viewPrintConsoleInput = A2(
		$mdgriffith$elm_ui$Element$Input$text,
		_List_Nil,
		{label: viewInputLabel, onChange: $author$project$Msg$ConsoleLogMessageInputChanged, placeholder: $elm$core$Maybe$Nothing, text: ''});
	var viewButtonLabel = A2(
		$mdgriffith$elm_ui$Element$el,
		_List_Nil,
		$mdgriffith$elm_ui$Element$text('Print'));
	var viewPrintButton = A2(
		$mdgriffith$elm_ui$Element$Input$button,
		$author$project$View$buttonAttr,
		{
			label: viewButtonLabel,
			onPress: $elm$core$Maybe$Just($author$project$Msg$ConsoleLogButtonClicked)
		});
	var viewContent = A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
	...
	return A2(
		...
		_List_fromArray(
			[
				$author$project$View$viewTitle('Console Print'),
				viewContent
			]));
}();
...
var $author$project$View$viewKeyPressed = function (keyPressed) {
	var viewHeading = A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		$mdgriffith$elm_ui$Element$text('Pressed Key: '));
	var viewContent = A2(
		$mdgriffith$elm_ui$Element$paragraph,
		_List_Nil,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$text('Key Pressed: '),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[$mdgriffith$elm_ui$Element$Font$bold, $mdgriffith$elm_ui$Element$Font$italic]),
				$mdgriffith$elm_ui$Element$text(
					A2($elm$core$Maybe$withDefault, '', keyPressed)))
			]));
	return A2(
		$mdgriffith$elm_ui$Element$column,
		$author$project$View$sectionAttr,
		_List_fromArray(
			[viewHeading, viewContent]));
};
var $author$project$View$viewQuote = function (quote) {
	var quoteHeading = A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		$mdgriffith$elm_ui$Element$text('Random Quote'));
	var additionalMsg = function (msg) {
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_Nil,
			$mdgriffith$elm_ui$Element$text(msg));
	};
	var quoteContent = function (quote_) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('\"' + (quote_.quote + '\"'))
						])),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
					...
					$mdgriffith$elm_ui$Element$text('~ ' + quote_.author)),
...
var $author$project$View$view = function (model) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					A2($mdgriffith$elm_ui$Element$spacingXY, 0, 50)
				]),
			_List_fromArray(
				[
					$author$project$View$viewBubbleGrid(model),
					$author$project$View$viewKeyPressed(model.keyPressed),
					$author$project$View$viewConsolePrintInput,
					$author$project$View$viewQuote(model.quote)
				])));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2($author$project$Model$initModel, $author$project$Cmd$initCmd);
		},
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Msg.Msg","aliases":{"Bubble.Bubble":{"args":[],"type":"{ state : Bubble.BubbleState, color : Bubble.Color }"},"Matrix.Matrix":{"args":["valType"],"type":"List.List (List.List valType)"},"Quote.Quote":{"args":[],"type":"{ msg : String.String, quote : String.String, author : String.String }"}},"unions":{"Msg.Msg":{"args":[],"tags":{"ClickedBubble":["Basics.Int","Basics.Int"],"GeneratedRandomMatrix":["Matrix.Matrix Bubble.Bubble"],"ChangedNumOfRows":["Basics.Float"],"ChangedNumOfColumns":["Basics.Float"],"ConfigChanged":[],"QuoteRecieved":["Result.Result Http.Error (List.List Quote.Quote)"],"KeyPressed":["String.String"],"ConsoleLogMessageInputChanged":["String.String"],"ConsoleLogButtonClicked":[]}},"Bubble.BubbleState":{"args":[],"tags":{"Popped":[],"Unpopped":[]}},"Bubble.Color":{"args":[],"tags":{"Green":[],"Red":[],"Blue":[],"Yellow":[],"Black":[],"Grey":[],"NoColor":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));