...
var $author$project$Main$GeneratedRandomMatrix = function (a) {
...
var $author$project$Main$Unpopped = {$: 'Unpopped'};
...
var $author$project$Main$randomColor = A2(
	$elm$random$Random$uniform,
	$author$project$Main$Red,
	_List_fromArray(
		[$author$project$Main$Green, $author$project$Main$Blue, $author$project$Main$Yellow, $author$project$Main$Black]));
var $author$project$Main$randomMatrix = F2(
	function (r, c) {
		return A2(
			...
			A2(
				...
				A2(
					$elm$random$Random$map,
					function (color) {
						return {color: color, state: $author$project$Main$Unpopped};
					},
					$author$project$Main$randomColor)));
	});
var $author$project$Main$generateNewMatrix = function (model) {
	return A2(
		$elm$random$Random$generate,
		$author$project$Main$GeneratedRandomMatrix,
		A2($author$project$Main$randomMatrix, model.rows, model.columns));
};
...
var $author$project$Main$initModel = {
	...
	matrix: _List_fromArray(
		[_List_Nil]),
	matrixState: $author$project$Main$Idle,
	rows: 10
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Main$NoColor = {$: 'NoColor'};
var $author$project$Main$Popped = {$: 'Popped'};
var $author$project$Main$changeBubbleState = F3(
	function (r, c, matrix) {
		return A2(
						...
						F2(
							function (ic, bubble) {
								return _Utils_eq(ic, c) ? _Utils_update(
									bubble,
									{color: $author$project$Main$NoColor, state: $author$project$Main$Popped}) : bubble;
							}),
						row) : row;
				}),
			matrix);
...
var $author$project$Main$isValidBubble = F3(
	function (r, c, matrix) {
...
var $author$project$Main$bfsHelper = F4(
...
var $author$project$Main$bfsBubble = F4(
	function (x, y, matrix, color) {
		...
		return A4($author$project$Main$bfsHelper, queue, visited, matrix, color);
	});
...
var $author$project$Main$movePoppedBubblesUpwards = function (column) {
	var _v0 = A2(
		$elm$core$List$partition,
		function (bubble) {
			return _Utils_eq(bubble.state, $author$project$Main$Popped);
		},
		column);
	var popped = _v0.a;
	var unpopped = _v0.b;
...
var $author$project$Main$identity = function (val) {
	return val;
};
...
var $author$project$Main$transpose = function (matrix) {
	if (!matrix.b) {
		return _List_Nil;
	} else {
		if (!matrix.a.b) {
			...
			return A2(
				$elm$core$List$cons,
				heads,
				$author$project$Main$transpose(tails));
		}
	}
};
var $author$project$Main$updateBubbles = function (matrix) {
	var columns = $author$project$Main$transpose(matrix);
	var newColumns = A2($elm$core$List$map, $author$project$Main$movePoppedBubblesUpwards, columns);
	return $author$project$Main$transpose(newColumns);
};
	...
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				return _Utils_Tuple2(
					model,
					$author$project$Main$generateNewMatrix(model));
		}
	});
...
var $author$project$Main$ClickedBubble = F2(
	function (a, b) {
		return {$: 'ClickedBubble', a: a, b: b};
	});
var $author$project$Main$bubbleDiameter = 30;
...
var $author$project$Main$getRgbColor = function (color) {
	switch (color.$) {
		case 'Red':
...
var $author$project$Main$bubbleGrid = function (matrix) {
	var viewBubble = F3(
		function (x, y, bubble) {
			return A2(
				...
				_List_fromArray(
					[
						...
						A2($author$project$Main$ClickedBubble, x, y)),
				...
				A2(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$px($author$project$Main$bubbleDiameter)),
							...
							function (_v0) {
								...
								$author$project$Main$getRgbColor(bubble.color))),
...
var $author$project$Main$ChangedNumOfColumns = function (a) {
	return {$: 'ChangedNumOfColumns', a: a};
};
var $author$project$Main$ChangedNumOfRows = function (a) {
	return {$: 'ChangedNumOfRows', a: a};
};
var $author$project$Main$ConfigChanged = {$: 'ConfigChanged'};
...
var $author$project$Main$generateNewMatrixButton = A2(
	$mdgriffith$elm_ui$Element$Input$button,
	_List_Nil,
	{
		label: $mdgriffith$elm_ui$Element$text('Generate New Matrix'),
		onPress: $elm$core$Maybe$Just($author$project$Main$ConfigChanged)
	});
var $author$project$Main$Grey = {$: 'Grey'};
...
var $author$project$Main$slider = F3(
							...
							_List_fromArray(
								[
									...
									function (_v0) {
										...
										$author$project$Main$getRgbColor($author$project$Main$Grey))),
...
var $author$project$Main$config = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A3($author$project$Main$slider, 'Rows', model.rows, $author$project$Main$ChangedNumOfRows),
				A3($author$project$Main$slider, 'Columns', model.columns, $author$project$Main$ChangedNumOfColumns),
				$author$project$Main$generateNewMatrixButton
			]));
};
	...
	var heading = A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$text('Bubble')),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text('Click on a bubble to pop it and some bubbles close by of same color'))
			]));
	var content = A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
		...
		_List_fromArray(
			[
				$author$project$Main$bubbleGrid(model.matrix),
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2(
				...
				$author$project$Main$generateNewMatrix($author$project$Main$initModel));
		},
